...
@Service
public class GenerateExcelSum {
    private ExcelAllSum excelAllSum;

    public GenerateExcelSum(ExcelAllSum excelAllSum) {
        this.excelAllSum = excelAllSum;
    }

    public void getSum(Workbook book) {
        List<List<String>> data = this.excelAllSum.getExcelAllSum();
        Sheet sheet = book.createSheet("общая");
        GenerateInteger.setStylePrint(sheet, false, false);
